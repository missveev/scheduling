...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'classroom_instances.ergo'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'classroom_instances#for_add.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'classroom_instances#for_add.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'classroom_instances.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'classroom_instances.fls2'
#mode restore
