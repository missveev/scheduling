...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'CourseCodes.ergo'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'CourseCodes#for_add.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'CourseCodes#for_add.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'CourseCodes.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'CourseCodes.fls2'
#mode restore
