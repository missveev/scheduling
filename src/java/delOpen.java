 ...
 * @author reslab
 */
public class delOpen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String delete = "DELETE FROM `opencourse` WHERE `courseGroup` = '" + course_id + "'";
            try {
                ...
                if (i > 0) {
                    ...
                    request.setAttribute("alertMsg", "deleted successfully");
