 ...
 * @author reslab
 */
public class perCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String year = request.getParameter("count");
             String buffer="<select name='course' ><option value='-1'>Select</option>";
            //out.println("course="+course_id);

            String sql = "SELECT course FROM `timetable` WHERE `year` = '" + year + "'";
 ...
 response.getWriter().println(buffer); 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(perCourse.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
