        ...
        <div class="page-wrapper bg-dark p-t-100 p-b-50">
            <div class="wrapper wrapper--w900">
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    if ((year != null) && (semester != null)) {
                                                        sql = "SELECT * FROM `timetable` WHERE department='" + deptt + "' and year='" + year + "' and semester='" + semester + "'";
                ...
                <div class="footer" >
                    ...
                    <a href="delTime" class="btn btn--radius-2 btn--blue-2">DELETE TIMETABLE</a>
                </div>
            </div>
        </div>
