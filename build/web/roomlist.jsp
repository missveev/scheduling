<%-- 
    Document   : roomlist
    Created on : Jan 10, 2019, 10:45:39 PM
    Author     : Pamilerin
--%>
                                ...
                                <tbody>
                                    ...
                                    <%
                                        try {
                                            ...
                                            String sql = "SELECT * FROM `room` WHERE department='"+dept+"'";
                                    ...
                                    <tr>
                                        ...
                                        <td class="column1"><%=resultSet.getString("room_id")%></td>
                                        <td class="column2"><%=resultSet.getString("faculty")%></td>
                                        <td class="column3"><%=resultSet.getString("department")%></td>
                                        <td class="column4"><%=resultSet.getString("capacity")%></td>
                                        <td class="column5"><a href='edRoom.jsp?d=<%=resultSet.getString("room_id")%>' >EDIT</A> &nbsp; <a href='delRoom?d=<%=resultSet.getString("room_id")%>'>DELETE</A></td>
