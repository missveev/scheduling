<%-- 
    Document   : opencourselist
    Created on : Jan 10, 2019, 10:47:35 PM
    Author     : Pamilerin
--%>
            ...
            <div class="wrapper wrapper--w900">
                <div class="card card-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="limiter" id="outputDiv">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr class="table100-head">
                                                    <th class="column1">OpenCourseID</th>
                                                    <th class="column2">Code</th>
                                                    <th class="column3">GroupNo</th>
                                                    <th class="column4">Max Student</th>
                                                    <th class="column5">Program</th>
                                                    <th class="column6">Semester</th>
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    if ((year.equals("ALL")) || (year.equals("ALL"))) {
                                                        sql = "SELECT * FROM `opencourse` WHERE department='" + dept + "'";

                                                    } else if ((year != "ALL") && (semester != "ALL")) {
                                                        sql = "SELECT * FROM `opencourse` WHERE year='" + year + "' and semester ='" + semester + "' and department='" + dept + "'";
                                                    } else {

                                                        sql = "SELECT * FROM opencourse WHERE year='" + error + "'";
                                                    }
                                            ...
                                            <tr>
                                                <td class="column1"><%=resultSet.getString("courseGroup")%></td>

                                                <td class="column2"><%=resultSet.getString("courseCode")%></td>
                                                <td class="column3"><%=resultSet.getString("groupNo")%></td>
                                                <td class="column4"><%=resultSet.getString("maxStudent")%></td>
                                                <td class="column5"><%=resultSet.getString("program")%></td>
                                                <td class="column6"><%=resultSet.getString("semester")%></td>
                                                <td class="column6"><%=resultSet.getString("year")%></td>
                                                <td class="column7"><a href='edOpen.jsp?d=<%=resultSet.getString("courseGroup")%>' >EDIT</A> &nbsp; <a href='delOpen?d=<%=resultSet.getString("courseGroup")%>'>DELETE</A></td>
                        ...
                        <a href="deleteOpen" class="btn btn--radius-2 btn--blue-2">DELETE ALL</a>
                        <a href="opencourse.jsp" class="btn btn--radius-2 btn--blue-2">ADD NEW COURSEOPENING</a>
                    </div>
                </div>
            </div>
        </div>
