...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'generate_meeting_times8c.flr'
#mode restore
/************************************************************************
