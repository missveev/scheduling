...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'constraints.flr'
#mode restore
...
#endif
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors),2)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_ignore_undefined_errors)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_ignore_undefined_errors)),2)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h170709,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_ignore_undefined_errors))(_h170709,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h170709,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_ignore_undefined_errors))(_h170709,FWContext)))) ) ).
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(system_turn_off_debug),2)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_off_debug)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_off_debug)),2)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h171648,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_off_debug))(_h171648,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h171648,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_off_debug))(_h171648,FWContext)))) ) ).
...
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(system_turn_on_debug),2)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_on_debug)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_on_debug)),2)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h173296,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_on_debug))(_h173296,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h173296,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_on_debug))(_h173296,FWContext)))) ) ).
...
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(turn_debug_off_for_call),4)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_debug_off_for_call)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_debug_off_for_call)),4)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h174912,_h174914,_h174916,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_debug_off_for_call))(_h174912,_h174914,_h174916,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h174912,_h174914,_h174916,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_debug_off_for_call))(_h174912,_h174914,_h174916,FWContext)))) ) ).
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(turn_off_debug_list),2)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_off_debug_list)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_off_debug_list)),2)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h175751,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_off_debug_list))(_h175751,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h175751,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_off_debug_list))(_h175751,FWContext)))) ) ).
?-( ';'( ->(current_predicate(/(FLORA_THIS_WORKSPACE(turn_on_debug_list),2)),true), (dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_on_debug_list)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_on_debug_list)),2)),opaque)), assert(:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h176514,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_on_debug_list))(_h176514,FWContext))), assert(:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h176514,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_on_debug_list))(_h176514,FWContext)))) ) ).
