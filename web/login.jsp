<%-- 
    Document   : index
    Created on : Feb 22, 2019, 11:05:14 AM
    Author     : Pamilerin
--%>
                ...
                <div class="card card-6">
                    ...
                    <div class="card-body">
                        <form method="post" action="login">
                            <div class="form-row">
                                <div class="name" for="username">Username</div>  
                                <div class="value">
                                    <input id="username" name="username" type="text" placeholder="" class="input--style-6" required="">
                            ...
                            <div class="form-row">
                                <div class="name" for="password">Password</div>
                                <div class="value">
                                    <input id="password" name="password" type="password" placeholder="" class="input--style-6" required="">
                    ...
                    <div class="footer" >
                        <input class="btn btn--radius-2 btn--blue-2" name="lgn" type="submit" value="LOGIN">
                    </div>
                    </form>

                    <div class="label--desc">Don't have an account?</font> <a href="register.jsp">Register here </a></div>
                </div>
            </div>
        </div>
