<%-- 
    Document   : deptlist
    Created on : Feb 14, 2019, 5:36:54 AM
    Author     : Pamilerin
--%>
                        ...
                        <div class="card-body">
                            ...
                            <div class="limiter">
                                ...
                                <tr>
                                    ...
                                    <td class="column1"><%=resultSet.getString("id")%></td>
                                    <td class="column2"><%=resultSet.getString("name")%></td>
                                    <td class="column3"><%=resultSet.getString("faculty")%></td>
                                    
                                    <td class="column4"><input type='submit' class='btn btn-danger' name='delete' value='Delete'></td>
